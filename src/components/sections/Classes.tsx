...
import crossfitImg from '../../assets/images/trainer-male.png';
    ...
    <Section id="classes" className="bg-zinc-950">
      <Container>
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-black text-white uppercase mb-4">Наши <span className="text-red-600">Классы</span></h2>
